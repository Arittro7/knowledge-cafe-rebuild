...
const Blog = ({ blog, handleAddToBookmark, handleMarkToRead }) => {
  ...
  return (
    <div className="">
      ...
      <button 
      className="mt-5 mb-16 text-xl font-bold text-orange-500"
      onClick={() =>handleMarkToRead(reading_time, id)}>Mark as read</button>
    </div>
  );
};
